...
const VendorAddForm = ({ type }: { type?: string }) => {
  const [vendorData, setVendorData] = useState({
    ...
    zipCode: "",
    status: "",
    // phoneNumberTwo: "", //vendor contact number
    Nda: "",
    YearOfNda: "",
    NdaExpiration: "",
    coi: "",
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!vendorData.name || !vendorData.zipCode) {
      toast.error("Please fill all the fields name, zipCode");
      return;
    }
    ...
    try {
      const res = await axios.post("/api/vendor", {
        ...vendorData,
        images: imagesLink,
      });
      ...
      toast.error("Not able to add Vendor");
