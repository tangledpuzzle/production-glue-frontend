...
DataTableProps<TData, TValue>) {
  ...
  const { venueTablePage, setVenueTablePage } = useVenueTablePageStore();
          ...
          <PaginationContent>
              ...
              <PaginationPrevious
               //  href="#"
                onClick={() => {
                  ...
                  table.previousPage();
                  setVenueTablePage(pageNumber.current);
                }}
                className={
            ...
            <div className="flex items-center gap-x-1">
              {Array.from({ length: table.getPageCount() }, (_, i) => i).map(
                (page) => {
                  const currentPageIndex = venueTablePage>=0? venueTablePage:  table.getState().pagination.pageIndex;
