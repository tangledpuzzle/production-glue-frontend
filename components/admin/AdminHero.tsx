  ...
  return (
    <div className="flex-col overflow-hidden relative flex min-h-[900px] w-full items-center  pt-5 max-md:max-w-full max-md:px-5">
      ...
      <div className="relative max-xl:h-[90vh] h-screen flex w-full max-w-[93%] flex-col max-md:max-w-full">
        ...
        <MobileMenu pageName="Admin" isOpen={isOpen} toggleOpen={toggleOpen} />
          ...
          <div className="flex md:flex-row flex-col justify-between w-full items-end">
            <div className="max-md:text-center">
              <MotionDiv
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.8, ease: "easeInOut" }}
                className="text-white text-6xl max-md:text-3xl 2xl:text-7xl 3xl:text-8xl leading-normal font-extrabold mt-10 max-md:max-w-full "
              >
                Uncover the{" "}
              ...
              <MotionDiv
                ...
                className="text-white text-lg 3xl:text-3xl max-md:text-sm 2xl:text-2xl leading-7 2xl:max-w-[900px] 3xl:max-w-[1120px] max-w-[572px] mt-8 max-md:max-w-full"
              >
